...
namespace _6partassignment
{
    class Program
    {
         Main()
        {
            // Assignment part one Create a console app that does/contains the following:
            //1 A one-dimensional array of strings., 2 Ask the user to input some text. 3 A loop that iterates through each string in the array and 
            //adds the user's text input to the end of each string. This step will not output anything to the console, 
            //but will update each array element by appending the user's text. 4Then create a second loop that prints off each string in the array one at a time.
            //Save and execute your code.

            Console.WriteLine();

            //Assignment Part 2 
           // Add the following to your console app and perform these actions: An infinite loop. Save your code. Fix the infinite loop so that it will execute properly.
        //Add comments to your code indicating how the infinite loop was fixed. Save and execute your code.
